...
namespace InfinityCode.OnlineMapsExamples
{
    ...
    public class FindDirectionExample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            (
                googleAPIKey,
                "Moscow", // FROM (string or Vector2)
                "Obninsk" // TO (string or Vector2)
            );
        ...
        private void OnFindDirectionComplete(string response)
        {
            ...
            OnlineMapsDrawingLine route = new OnlineMapsDrawingLine(result.routes[0].overview_polylineD, new Color(1, 0.6570523f ,0), 5);
